CREATE DATABASE  IF NOT EXISTS `stallv5` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `stallv5`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: stallv5
-- ------------------------------------------------------
...
--
-- Dumping events for database 'stallv5'
--

--
-- Dumping routines for database 'stallv5'
--
